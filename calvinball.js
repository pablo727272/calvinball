/*
        ...
        */
        ...
        if (crying === true) {
          score = score - 300;
          console.log(`score -300 if crying`);
          console.log(score);
        }
        if (crying === false) {
          score = score + 50;
          console.log(`score +50 if not crying`);
          console.log(score);
        }
        // 3
        if (last_play === "Q") {
          score = score - 77;
          console.log(`score -77 if last play Q`);
          console.log(score);
        }
        // 4
        if (is_in_tree === true && isNaN(last_play)) {
          score = score + 395;
          console.log(`score +395 if in tree and last play was not a number`);
          console.log(score);
        }
        // 5
        if (broom === "handle") {
          score = score * 2;
          console.log(`score *2 if broom handle`);
          console.log(score);
        }
        if (broom === "brush") {
          score = score * 3;
          console.log(`score *3 if broom brush`);
          console.log(score);
        }
        if (broom != "handle" && broom != "brush") {
          score = score / 2;
          console.log(`score /2 if neither broom nor brush`);
          console.log(score);
        }
        // 6
        if (has_ball === true && is_in_tree === false && crying === false) {
          score = score * 1.5;
          console.log(`score *1.5 if has ball, not in tree, and not crying`);
          console.log(score);
        }
        // 7
        if (!isNaN(last_play)) {
          score = score * last_play;
          console.log(`score *last_play if last play was a number`);
          console.log(score);
        }
